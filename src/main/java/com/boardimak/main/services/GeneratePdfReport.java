...
//			            table.addCell(cell);
			...
			public static ByteArrayInputStream UserReportGenerate(List<User> users) {
		        ...
		        try {
		            ...
		            hcell = new PdfPCell(new Phrase("User type", headFont));
		            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		            table.addCell(hcell);
		            ...
		            for (User user : users) {
		                ...
		                cell = new PdfPCell(new Phrase( user.getUserType() ));
		                cell.setPaddingLeft(5);
		                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		                table.addCell(cell);
